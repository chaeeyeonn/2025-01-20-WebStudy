...
public class MainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String html="<nav class=\"navbar navbar-inverse\">"
				...
				+ "          <li><a href=\"MainServlet?mode=1\">음악목록</a></li>"
				+ "          <li><a href=\"MainServlet?mode=3\">음악검색 1</a></li>"
				+ "          <li><a href=\"MainServlet?mode=4\">음악검색 2</a></li>"
				+ "        </ul>"
				+ "      </li>"
				+ "      <li><a href=\"#\">게시판</a></li>"
				+ "      <li><a href=\"#\">기타</a></li>"
		 ...
		 *  => 보안 good / 누구나 볼 수 있음 => 보안 취약
		 *  => Object / String
		 *  
		 *  - Session
		 *  => 로그인 처리시 => 사용자의 일부 정보 저장: Session
		 *  => 예약시 선택한 내용 / 장바구니: Session  
		 *  => 비밀번호: 암호화
		 *  
		 *  => 주요 메소드 => 같은 브라우저에서는 사용자당 1개만 세션사용 가능
		 *    - 저장: setAttribute()
		 *    - 읽기: getAttribute()
		 *    - 삭제: removeAttribute()
