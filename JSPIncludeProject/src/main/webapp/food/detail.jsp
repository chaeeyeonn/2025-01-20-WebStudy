    ...
    <div class="content"> 
      ...
      <ul class="slides">
       <c:forTokens var="image" items="${vo.images }" delims=",">
        <li>
          <figure><img class="radius-10 btmspace-10" src="https://www.menupan.com${image }" style="width: 320px;height: 185px">
          </figure>
        </li>
       </c:forTokens>
      </ul>
       ...
       <table class="table">
         ...
         <tr>
          ...
          <a href="#" class="btn btn-sm btn-primary">예약하기</a>
